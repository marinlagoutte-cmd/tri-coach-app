 ...
 *
 * DEUX NIVEAUX DE CONFIANCE, retournés mais qui ne déclenchent plus AUCUNE confirmation
 * automatique (demande explicite de l'athlète, 03/09 — avant, une correspondance 'exact'
 * était auto-confirmée ; ce n'est plus le cas, voir webhook.js/stravaSync.js) :
 ...
 * Dans les deux cas, le résultat n'est qu'une SUGGESTION (matched_workout_id posé,
 * match_confirmed=false) affichée dans ActivityDetail.js — à valider soi-même à la main.
 *
 ...
 * utilisée pour borner l'import manuel Strava aux "12 dernières semaines" (voir
 * handleStravaSync dans SettingsModal.js et pages/api/strava/sync.js), pour que
 * l'onglet Profil (graphes de tendance, métriques auto-détectées, courbe de progression
 * sur 12 semaines) ait assez d'historique même pour un athlète qui vient de lier son
 * compte.
 */
