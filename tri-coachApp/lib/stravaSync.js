...
export async function importStravaActivities({
  ...
  for (const raw of missingActivities) {
    ...
    rows.push({
      ...
      // plus aucune association automatique — matched_workout_id reste une SUGGESTION,
      // jamais confirmée sans validation manuelle de l'athlète dans ActivityDetail.js.
