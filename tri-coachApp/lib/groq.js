...
// MàJ 2026-08-28 : llama-3.3-70b-versatile et llama-3.1-8b-instant ont été
// dépréciés par Groq (annonce du 17/06/2026, arrêt définitif le 16/08/2026 —
// d'où l'erreur "model_not_found" côté prod). Migration recommandée par Groq :
// openai/gpt-oss-120b (remplace llama-3.3-70b-versatile) et openai/gpt-oss-20b
// (remplace llama-3.1-8b-instant). Voir https://console.groq.com/docs/deprecations
const DEFAULT_CANDIDATES = ['openai/gpt-oss-120b', 'openai/gpt-oss-20b'];
...
function classifyError(err) {
  ...
  if (status === 413 || /too large|tokens per minute|reduce your message size/i.test(msg)) {
