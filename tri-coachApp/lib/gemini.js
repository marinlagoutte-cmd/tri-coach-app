 ...
 */
export async function regenerateWeekWithAI({ weekKey = 'N+1', profile, workouts, trainingPlan, constraints, feedbackHistory, healthHistory, manualPaceZones, language = 'fr' }) {
...
{ "workouts": { "${weekKey}": [...] } }`;
  ...
  const reviewed = await reviewPlanCoherenceWithAI({ sanitized: sanitizedForReview, wizardData, resolvedProfile, phase, currentPhaseKey, isTriathlon });
