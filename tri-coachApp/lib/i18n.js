...
const DICT = {
  ...
  tools: {
    fr: { tirePressureSubTab: '🚴 Pression pneus', equipmentSubTab: '🔧 Matériel', routeSubTab: '🗺️ Parcours' },
    en: { tirePressureSubTab: '🚴 Tire pressure', equipmentSubTab: '🔧 Gear', routeSubTab: '🗺️ Route' },
    es: { tirePressureSubTab: '🚴 Presión de neumáticos', equipmentSubTab: '🔧 Material', routeSubTab: '🗺️ Ruta' },
  },
  auth: {
  ...
  settings: {
    fr: {
      ...
      stravaSyncHint: "Récupère tes activités Strava du dernier mois pour compléter le calendrier et les graphes de l'onglet Profil. Le webhook s'occupe déjà des nouvelles activités automatiquement — ce bouton sert surtout à rattraper l'historique récent.",
    ...
    en: {
      ...
      stravaSyncHint: "Fetches your Strava activities from the last month to fill in your calendar and the Profile tab's charts. New activities are already picked up automatically by the webhook — this button is mainly to catch up on recent history.",
      stravaSyncSuccess: ({ imported = 0, skipped = 0, limited = false } = {}) => (imported > 0
    ...
    es: {
      ...
      stravaSyncHint: 'Recupera tus actividades de Strava del último mes para completar el calendario y los gráficos de la pestaña Perfil. El webhook ya se encarga de las nuevas actividades automáticamente — este botón sirve sobre todo para recuperar el historial reciente.',
      stravaSyncSuccess: ({ imported = 0, skipped = 0, limited = false } = {}) => (imported > 0
