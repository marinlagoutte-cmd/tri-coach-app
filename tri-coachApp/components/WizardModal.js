            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-ink-950 border border-ink-800 rounded-xl p-2.5 text-xs text-ink-50 placeholder-ink-600"
                />
              </div>
              ...
              <div className="bg-ink-950 border border-ink-800 rounded-xl p-3 space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <input
                    ...
                    className="w-full bg-ink-900 border border-ink-800 rounded-xl p-2 text-xs text-ink-50 placeholder-ink-600"
                  />
                  <input
                    type="text"
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`p-2 rounded-xl text-[10px] font-bold whitespace-pre-line leading-tight border transition-colors ${
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <div className="w-full bg-ink-950 border border-ink-800 rounded-xl p-2.5 text-xs text-ink-50 font-mono pointer-events-none flex justify-between items-center">
              ...
              <div>
                ...
                {Number(formData.maxSessionsPerWeek) > 7 && (
                  <p className="text-[10px] text-volt-400 mt-1">⚡ Plus de 7 séances/semaine implique des jours "doubles" (2 séances le même jour, ex : brick).</p>
                )}
              </div>

              <div>
                <label className="text-xs text-ink-400 block mb-1">Jour(s) de repos obligatoire</label>
                <select value={formData.offDays} onChange={(e) => setFormData({ ...formData, offDays: e.target.value })} className="w-full bg-ink-950 border border-ink-800 rounded-xl p-2.5 text-xs text-ink-50">
