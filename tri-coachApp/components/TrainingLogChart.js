...
const WEEK_SUMMARY_BY_METRIC = {
  ...
  // Pas de "totalDurationMin" séparé : totalDurationH (déjà calculé pour l'agrégat
  // semaine) reconverti ici en minutes pour rester dans la même unité que le toggle
  // "Temps" (bulles en minutes) plutôt que de mélanger heures et minutes à l'écran.
  durationMin: { total: (w) => Math.round(w.totalDurationH * 60), format: (v) => `${v} min` },
