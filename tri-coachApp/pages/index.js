      ...
      <main key={activeTab} className="flex-1 max-w-md w-full mx-auto p-4 space-y-4 animate-fadeIn">
        ...
        {activeTab === 'tools' && (
          <div className="space-y-4">
            {/* grid-cols-5 : CORRIGÉ (était grid-cols-4, laissant le 5e sous-onglet
                "route" retomber sur une ligne implicite à part depuis son ajout — les
                5 sous-onglets tiennent maintenant sur une seule ligne). */}
            <div className="grid grid-cols-5 gap-1 bg-ink-900 border border-ink-800 rounded-2xl p-1">
        ...
        {activeTab === 'profile' && (
          <div className="space-y-4">
            <ProfileHealth profile={profile} onProfileChange={handleProfileChange} sportType={sportType} onRequestLighten={handleHrvLighten} stravaActivities={stravaActivities} />
