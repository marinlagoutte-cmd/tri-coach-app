...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { trainingPlan, workouts, resolvedProfile, qualityWarnings, autoFixNotes } = await generatePlanWithAI({ wizardData, profile, feedbackHistory, healthHistory, manualPaceZones, language: lang });
