...
export default async function handler(req, res) {
  ...
  const { wizardData, profile, feedbackHistory, healthHistory, manualPaceZones, injuryLog, raceCalendar, menstrualCycle, language } = req.body || {};
  ...
  try {
    ...
    const { trainingPlan, workouts, resolvedProfile, qualityWarnings, autoFixNotes } = await coGeneratePlan({ wizardData, profile, feedbackHistory, healthHistory, manualPaceZones, injuryLog, raceCalendar, menstrualCycle, language: lang });
