...
//
// FRÉQUENCE RÉELLE : vercel.json déclare "0 5 * * *" (1x/jour, 5h du matin) — plan Vercel
// Hobby, dont les Cron Jobs sont limités à 1 exécution/JOUR maximum par entrée (un cron plus
// fréquent, ex. horaire, fait ÉCHOUER LE DÉPLOIEMENT ENTIER, pas juste le cron). Pour une
// fréquence plus élevée, passer au plan Pro puis assouplir l'horaire ci-dessous (ex.
// "0 */6 * * *" = toutes les 6h). Rien d'autre à changer côté code dans ce cas.
