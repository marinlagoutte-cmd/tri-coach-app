...
// coup — c'est tout l'intérêt du diagnostic (ex: voir que llama-3.1-8b-instant est
// décommissionné même si llama-3.3-70b-versatile répond très bien).
...
const GROQ_CANDIDATES = (process.env.GROQ_PREFERRED_MODELS || 'llama-3.3-70b-versatile,llama-3.1-8b-instant')
  .split(',').map((s) => s.trim()).filter(Boolean);
