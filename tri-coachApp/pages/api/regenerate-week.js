...
export default async function handler(req, res) {
  ...
  const { weekKey, profile, workouts, trainingPlan, constraints, feedbackHistory, healthHistory, manualPaceZones, injuryLog, raceCalendar, menstrualCycle, language } = req.body || {};
