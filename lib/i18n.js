...
const DICT = {
  ...
  tabs: {
    fr: { nutrition: 'Nutrition', calendar: 'Calendrier', objective: 'Objectif', weather: 'Météo', profile: 'Outils', chat: 'Coach Chat' },
    en: { nutrition: 'Nutrition', calendar: 'Calendar', objective: 'Goal', weather: 'Weather', profile: 'Tools', chat: 'Coach Chat' },
    es: { nutrition: 'Nutrición', calendar: 'Calendario', objective: 'Objetivo', weather: 'Clima', profile: 'Herramientas', chat: 'Chat Coach' },
  },
  // Sous-onglets de l'onglet Outils (ex-Profil) : Profil & données santé / Pression pneus.
  tools: {
    fr: { profileSubTab: 'Profil', tirePressureSubTab: '🚴 Pression pneus' },
    en: { profileSubTab: 'Profile', tirePressureSubTab: '🚴 Tire pressure' },
    es: { profileSubTab: 'Perfil', tirePressureSubTab: '🚴 Presión de neumáticos' },
  },
  auth: {
