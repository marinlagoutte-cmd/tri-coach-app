...
const DICT = {
  ...
  chat: {
    fr: { addIntent: "➕ Ajout d'une séance supplémentaire", modifyIntent: '✏️ Modification de séance', placeholder: 'Ex: Décale ma séance de vélo à jeudi...', thinking: 'Coach analyse et recalcule tes cibles...', welcome: (n) => `👋 Salut${n ? ' ' + n : ''} ! Ton plan d'entraînement est opérationnel. Quelle séance souhaites-tu passer en revue ?` },
    en: { addIntent: '➕ Add an extra session', modifyIntent: '✏️ Modify a session', placeholder: 'E.g. Move my bike session to Thursday...', thinking: 'Coach is analyzing and recalculating your targets...', welcome: (n) => `👋 Hi${n ? ' ' + n : ''}! Your training plan is ready. Which session would you like to review?` },
    es: { addIntent: '➕ Añadir una sesión extra', modifyIntent: '✏️ Modificar una sesión', placeholder: 'Ej: Cambia mi sesión de bici al jueves...', thinking: 'El coach está analizando y recalculando tus objetivos...', welcome: (n) => `👋 Hola${n ? ' ' + n : ''}! Tu plan de entrenamiento está listo. ¿Qué sesión quieres revisar?` },
  },
  profile: {
