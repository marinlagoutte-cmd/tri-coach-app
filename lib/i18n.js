...
const DICT = {
  ...
  tabs: {
    fr: { nutrition: 'Nutrition', calendar: 'Calendrier', objective: 'Objectif', weather: 'Météo', profile: 'Profil', chat: 'Coach Chat' },
    en: { nutrition: 'Nutrition', calendar: 'Calendar', objective: 'Goal', weather: 'Weather', profile: 'Profile', chat: 'Coach Chat' },
    es: { nutrition: 'Nutrición', calendar: 'Calendario', objective: 'Objetivo', weather: 'Clima', profile: 'Perfil', chat: 'Chat Coach' },
  },
  auth: {
  ...
  settings: {
    fr: {
      ...
      stravaSync: 'Importer mon historique Strava', stravaSyncing: 'Import en cours…',
      stravaSyncHint: "Récupère toutes tes activités déjà enregistrées sur Strava (avant même la liaison du compte) pour compléter le calendrier. Le webhook s'occupe déjà des nouvelles activités automatiquement — ce bouton sert seulement à rattraper l'historique.",
      stravaSyncSuccess: (imported, skipped) => imported > 0
    ...
    en: {
      ...
      stravaSync: 'Import my Strava history', stravaSyncing: 'Importing…',
      stravaSyncHint: "Fetches every activity already recorded on Strava (even before you linked your account) to fill in your calendar. New activities are already picked up automatically by the webhook — this button is only to catch up on past history.",
      stravaSyncSuccess: (imported, skipped) => imported > 0
    ...
    es: {
      ...
      stravaSync: 'Importar mi historial de Strava', stravaSyncing: 'Importando…',
      stravaSyncHint: 'Recupera todas las actividades ya registradas en Strava (incluso antes de vincular la cuenta) para completar el calendario. El webhook ya se encarga de las nuevas actividades automáticamente — este botón solo sirve para recuperar el historial.',
      stravaSyncSuccess: (imported, skipped) => imported > 0
  ...
  outlook: {
    fr: { title: 'Aperçu {{label}}', hint: 'Projection déterministe (phase/volume estimé) — le détail séance par séance sera généré plus près de cette semaine.', hours: '~{{h}}h prévues', sessions: '{{n}} séances visées', noTarget: "Renseigne un objectif (date) pour voir cet aperçu." },
    en: { title: 'Preview {{label}}', hint: 'Deterministic projection (phase/estimated volume) — day-by-day detail will be generated closer to that week.', hours: '~{{h}}h planned', sessions: '{{n}} sessions targeted', noTarget: 'Set a goal (date) to see this preview.' },
    es: { title: 'Vista previa {{label}}', hint: 'Proyección determinista (fase/volumen estimado) — el detalle día a día se generará más cerca de esa semana.', hours: '~{{h}}h previstas', sessions: '{{n}} sesiones previstas', noTarget: 'Define un objetivo (fecha) para ver esta vista previa.' },
  },
  profile: {
