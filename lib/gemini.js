...
- RUN : intensity = allure OBLIGATOIREMENT au format min/km (ex: "4:30 /km"), JAMAIS en km/h,
  effortZone = zone d'effort (Z1-Z5), avgBpm = BPM moyen estimé.
- BIKE : intensity = watts cible, rpe = effort ressenti (RPE x/10), cardio = zone FC + bpm moyen.
- SWIM : intensity = allure OBLIGATOIREMENT au format min/100m (ex: "1:35 /100m"), effortZone = zone d'effort.
- ATTENTION PARTICULIÈRE : le champ "intensity" (allure/watts) doit être précis et propre à CHAQUE séance
  (jamais une valeur générique recopiée d'une autre séance) — c'est la donnée la plus consultée par l'athlète.
...
- Les valeurs (allure, watts, BPM) DOIVENT rester dans les bornes physiologiques réalistes du profil fourni (VMA, FTP, allure CSS, FC max/repos) : ne jamais halluciner.
