...
{ "workouts": { "N": [...], "N+1": [...] } }`;
  ...
  if (physio.vmaSource?.startsWith('non renseignée')) missingMetrics.push('C.A.P');
  if (isTriathlon && physio.ftpSource?.startsWith('non renseignée')) missingMetrics.push('CYCLISME');
  if (isTriathlon && physio.nat100Source?.startsWith('non renseignée')) missingMetrics.push('NATATION');
