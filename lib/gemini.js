...
export async function generatePlanWithAI({ wizardData, profile, feedbackHistory, healthHistory, language = 'fr' }) {
...
export async function chatWithCoach({ message, profile, workouts, trainingPlan, intent, sportType, constraints, feedbackHistory, healthHistory, language = 'fr' }) {
