    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm p-4">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg p-6 shadow-2xl space-y-6 text-slate-100 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-mono text-slate-500">Étape {step} / 5</span>
        </div>
        ...
        <div className="space-y-4">
          ...
          {step === 4 && (
            <div className="space-y-4">
              <h3 className="text-xs font-black uppercase tracking-wide text-orange-400">4. Niveau &amp; données physio (facultatif)</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs text-slate-400 block mb-1">Âge (optionnel)</label>
                  <input
                    type="number"
                    value={formData.age}
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-800 rounded-xl p-2 text-xs text-white placeholder-slate-600"
                  />
                  <input
                    type="text"
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 space-y-2">
                <span className="text-[10px] text-slate-500 uppercase block font-mono">📊 Valeurs déjà mesurées (si tu les connais)</span>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-[10px] text-slate-500 block mb-1">VMA (km/h)</label>
                    <input
                  ...
                  <div>
                    <label className="text-[10px] text-slate-500 block mb-1">FC max (bpm)</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="text-[10px] text-slate-500 block mb-1">FC repos (bpm)</label>
                    <input
                      type="number"
                  ...
                  {formData.sportType === 'triathlon' && (
                    <>
                      <div>
                        <label className="text-[10px] text-slate-500 block mb-1">FTP vélo (W)</label>
                        <input
                          type="number"
                      ...
                      <div>
                        <label className="text-[10px] text-slate-500 block mb-1">Allure CSS nat. (/100m)</label>
                        <input
                          type="text"
          ...
          {step === 5 && (
            <div className="space-y-4">
              <h3 className="text-xs font-black uppercase tracking-wide text-orange-400">5. Date & disponibilités</h3>
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-1.5">
                  Avec {formData.maxSessionsPerWeek} séance(s)/semaine, le plan comptera <strong className="text-orange-400">{7 - Number(formData.maxSessionsPerWeek)} jour(s) de repos</strong> au total sur la semaine (dont le {formData.offDays}, obligatoire).
                </p>
              </div>
