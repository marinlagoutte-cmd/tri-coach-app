  ...
  return (
    <div className="min-h-screen bg-ink-950 flex items-center justify-center p-6">
      <div className="max-w-sm w-full bg-ink-900 border border-ink-800 rounded-2xl p-6 space-y-5 text-center">
        ...
        <div>
          <h1 className="text-lg font-black text-white font-display">Tri Coach</h1>
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-white text-ink-950 font-bold text-sm rounded-xl py-3 flex items-center justify-center gap-2.5 disabled:opacity-60 active:scale-[0.98] transition-all"
        >
