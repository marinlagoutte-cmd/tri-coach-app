  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* whitespace-pre-line : le formalisme "feuille de club" (Échauffement / Corps de
            séance / Total) repose sur de vrais retours à la ligne dans "desc" — sans cette
            classe, un <div> React les aurait silencieusement collapsés en un seul paragraphe,
            aussi bien pour les séances générées par l'IA que pour les templates de secours. */}
