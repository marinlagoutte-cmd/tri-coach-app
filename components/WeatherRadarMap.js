...
export default function WeatherRadarMap() {
  ...
  useEffect(() => {
    ...
    gridWindData.forEach((pt) => {
      ...
      if (!color) return;
      // Contour sombre semi-opaque systématique : c'est CE contour, pas le remplissage,
      // qui garantit la lisibilité quelle que soit la couleur de fond de la carte en dessous.
