...
const GRID_COLOR = 'rgba(129, 119, 172, 0.14)';
...
export default function PerformanceDashboard({ profile, workouts, feedbackHistory, sportType = 'triathlon' }) {
  ...
  const trendOptions = {
    ...
    plugins: {
      legend: { position: 'bottom', labels: { color: '#D8D4E8', font: { size: 11, weight: '600' }, boxWidth: 10, padding: 12 } },
  ...
  const volumeOptions = {
    ...
    scales: {
      ...
      x: { ticks: { color: '#D8D4E8', font: { size: 12, weight: '600' } }, grid: { display: false } },
    },
  };
