...
export default function PerformanceDashboard({ profile, workouts, feedbackHistory, sportType = 'triathlon', stravaActivities = [] }) {
    ...
    <div className="bg-ink-900 border border-ink-800 rounded-2xl p-4 space-y-4 text-ink-100">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <ZoneCharts profile={profile || {}} activities={stravaActivities} />
        </div>
      </div>
    </div>
  );
