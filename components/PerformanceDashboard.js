    ...
    <div className="bg-ink-900 border border-ink-800 rounded-2xl p-4 space-y-4 text-ink-100">
      ...
      <div className="space-y-4">
        ...
        {/* Zones FC & Puissance (vélo/course, switch par bouton) — alimentées par les
            activités Strava synchronisées ; bornes éditables manuellement, ou calculées
            automatiquement depuis Strava si Réglages > "Zones d'entraînement" est sur
            "Automatique" (voir lib/zonesMode.js et lib/zones.js:estimateZonesFromActivities). */}
        <div>
          <p className="text-xs font-bold text-ink-50 mb-0.5">Zones d'entraînement</p>
          <p className="text-[10px] text-ink-500 mb-2">Répartition du temps par zone (séances Strava) · bornes modifiables ou auto depuis Réglages</p>
