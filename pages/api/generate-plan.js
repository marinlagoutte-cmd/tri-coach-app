...
export default async function handler(req, res) {
  ...
  const { wizardData, profile, feedbackHistory, healthHistory, language } = req.body || {};
  ...
  try {
    ...
    const { trainingPlan, workouts, resolvedProfile, qualityWarnings, autoFixNotes } = await generatePlanWithAI({ wizardData, profile, feedbackHistory, healthHistory, language: lang });
