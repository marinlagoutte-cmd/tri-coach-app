...
export default async function handler(req, res) {
  ...
  const { wizardData, profile, feedbackHistory, language } = req.body || {};
  ...
  try {
    ...
    const { trainingPlan, workouts, resolvedProfile, qualityWarnings, autoFixNotes } = await generatePlanWithAI({ wizardData, profile, feedbackHistory, language: lang });
