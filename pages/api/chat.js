...
export default async function handler(req, res) {
  ...
  const { message, profile, workouts, trainingPlan, intent, sportType, constraints, feedbackHistory, healthHistory, language } = req.body || {};
  ...
  try {
    const { reply, patches } = await chatWithCoach({ message, profile, workouts, trainingPlan, intent, sportType, constraints, feedbackHistory, healthHistory, language: lang });
