...
export default async function handler(req, res) {
  ...
  const { weekKey, profile, workouts, trainingPlan, constraints, feedbackHistory, healthHistory, manualPaceZones, injuryLog, raceCalendar, menstrualCycle, language, clientDate } = req.body || {};
  ...
  try {
    ...
    const { workouts: updatedWorkouts, resolvedProfile, qualityWarnings, autoFixNotes, weekSummary } = await coRegenerateWeek({
      weekKey,
      profile,
      workouts,
      trainingPlan,
