...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-body flex flex-col pb-[calc(5rem+env(safe-area-inset-bottom))] md:pb-6 antialiased">
      ...
      <header className="sticky top-0 z-30 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 px-4 pt-[calc(0.75rem+env(safe-area-inset-top))] pb-3 flex items-center justify-between">
      ...
      <nav className="bg-slate-900 border-b border-slate-800 sticky top-[calc(53px+env(safe-area-inset-top))] z-20 px-2 py-2">
